-- Work with teachers in departments table:
...
-- 5 Use COALESCE to print the mobile number. Use the number '07986 444 2266' if there is no number
...
-- 8 Use COUNT and GROUP BY dept.name to show each department and the number of staff. Use a RIGHT
-- JOIN to ensure that the Engineering department is listed.
